...
INSERT INTO WEDDING_TASK (id, name, is_done, group_id) VALUES (1, 'első feladat', false, (select id from group_of_tasks where (name = 'harmadik csoport')));
INSERT INTO WEDDING_TASK (id, name, is_done, group_id) VALUES (2, 'második feladat', false, (select id from group_of_tasks where (name = 'harmadik csoport')));
INSERT INTO WEDDING_TASK (id, name, is_done, group_id) VALUES (3, 'harmadik feladat', false, (select id from group_of_tasks where (name = 'harmadik csoport')));
INSERT INTO WEDDING_TASK (id, name, is_done, group_id) VALUES (4, 'negyedik feladat', false, (select id from group_of_tasks where (name = 'harmadik csoport')));
INSERT INTO WEDDING_TASK (id, name, is_done, group_id) VALUES (5, 'ötödik feladat', false, (select id from group_of_tasks where (name = 'harmadik csoport')));
INSERT INTO WEDDING_TASK (id, name, is_done, group_id) VALUES (6, 'hatodik feladat', false, (select id from group_of_tasks where (name = 'hatodik csoport')));
